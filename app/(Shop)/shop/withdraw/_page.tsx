...
import { addWithDrawMethod } from "@/actions/addWithdrawMethod";
import { deleteWithDrawMethod } from "@/actions/deleteWithDrawMethod";
import { addWithdraw } from "@/actions/addWithdraw";
...
const WithDrawEarning = ({
  ...
  const handleDelete = async () => {
    setLoading(true);
    await deleteWithDrawMethod(shop?.bank?.id!).then((res:any) => {
      setLoading(false);
      setOpen(!open);
