  ...
  const columns = [
    ...
    { field: "price", headerName: "Prompt Price", flex: 0.5 },
    {
      ...
      renderCell: (params: any) => {
        ...
        //if any one click this will execute
    ...
    <>
      ...
      {loading ? (
        ...
        <div className="w-[90%] m-auto">
          ...
          {open && (
            <div className="w-full fixed top-0 left-0 z-[9999999] h-screen bg-[#02020220] flex items-center justify-center">
              <div className="md:w-[70%] xl:w-[40%] w-[90%] bg-white shadow rounded-xl p-5">
                <div className="w-full flex justify-end">
                  <RxCross1
                  // cross for cancel the popup window
                ...
                <div className="w-full">
                  ...
                  <Button
                    ...
                    //disabled for those who already give an review
                    disabled={orders
